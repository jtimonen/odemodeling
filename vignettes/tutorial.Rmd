...
```{r sho_data}
y1_obs <- c(0.801, 0.391, 0.321, -0.826, -0.234, -0.663, -0.756, -0.717,
...
Please refer to our paper for interpreting these metrics. Briefly we note that the Pareto-k values seem to be converging to a value smaller than 0.5, meaning that importance sampling is possible and we don't need to run MCMC again.
